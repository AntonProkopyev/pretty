...
windows_library_sources = [
    ...
    "$(S)/std/ios/out_fd.cpp",
    "$(S)/std/ios/out_fd_coro.cpp",
    "$(S)/std/ios/out_mem.cpp",
    "$(S)/std/ios/out_null.cpp",
    "$(S)/std/ios/out_zc.cpp",
    "$(S)/std/ios/output.cpp",
    "$(S)/std/ios/fs_utils.cpp",
    "$(S)/std/ios/sys.cpp",
